...
const aiOptions: AIOption[] = [
  { id: "docs", title: "Documentação", icon: "📚", href: "http://localhost:3001" },
  { id: "chatgpt", title: "ChatGPT", icon: "🤖", href: "http://localhost:3002" },
  { id: "gemini", title: "Gemini", icon: "🔮", href: "http://localhost:3003" },
